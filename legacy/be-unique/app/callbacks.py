"""Session bootstrap and tool guardrails for the Be Unique orchestrator."""
...
def seed_session_state(
    ...
    state.setdefault("explicit_human_request", "")
    state.setdefault("active_sede", "")
    state.setdefault("customer_name", "")
    state.setdefault("active_service_name", "")
    state.setdefault("active_duration_minutes", "")
    state.setdefault("last_booking_id", "")
    state.setdefault("last_booking_label", "")
    ...
    if "not found" in message.lower():
        return {
            "error": (
                ...
                "escribe su respuesta final directamente como texto."
            ),
