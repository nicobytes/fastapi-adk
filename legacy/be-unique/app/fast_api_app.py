...
from chatty_agent_common.sentry import attach_sentry_verify_route, init_sentry
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    # AgentCardBuilder needs an LlmAgent. Root is BaseAgent orchestrator (no
    # .model/.tools); use customer for model/tools and keep root name/description.
    card_agent = Agent(
...
app.title = "be-unique"
app.description = "API for interacting with the Agent be-unique"

attach_sentry_verify_route(app)
