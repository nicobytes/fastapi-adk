...
2. Carga solo los recursos L3 necesarios con `load_skill_resource`:
   ...
   - **Zonas disponibles:** `references/zonas.md`
   - **Valoración, preparación, cuidados, contraindicaciones:**
     `references/preparacion-cuidados.md`
   - **Preguntas frecuentes:** `references/faqs-laser.md`
   - **Tarifario por zona:** `references/tarifario.md`
   - **Paquetes, combos, planes, redondeo:** `references/estructura-comercial.md`
   - **Políticas de paquetes:** `references/politicas-paquetes.md`
